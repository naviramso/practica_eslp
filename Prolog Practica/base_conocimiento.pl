...
pelicula('Goodfellas', drama, 'La historia de la vida real del gánster Henry Hill y su participación en la mafia italiana en Nueva York.', 'goodfellas.jpg').
actores('Goodfellas', ['Robert De Niro', 'Ray Liotta', 'Joe Pesci']).

pelicula('The Godfather Part II', drama, 'Una secuela que sigue la vida de Vito Corleone y su hijo Michael, explorando su ascenso al poder en el mundo del crimen organizado.','elpadrino2.jpeg').
actores('The Godfather Part II', ['Robert De Niro', 'Al Pacino']).

pelicula('Heat', accion, 'El enfrentamiento entre un ladrón de bancos y un tenaz detective de la policía de Los Ángeles, mientras ambos hombres persiguen sus propios códigos de honor.','heat.jpeg').
actores('Heat', ['Robert De Niro', 'Al Pacino']).

pelicula('The Irishman', drama, 'La historia de Frank Sheeran. un asesino a sueldo involucrado con la mafia y su supuesta participación en la desaparición del líder sindical Jimmy Hoffa.','irishman.jpg').
actores('The Irishman', ['Robert De Niro', 'Al Pacino', 'Joe Pesci']).

pelicula('Scarface', drama, 'La historia de Tony Montana. un inmigrante cubano que se convierte en un poderoso narcotraficante en Miami.', 'scarface.jpg').
actores('Scarface', ['Al Pacino', 'Michelle Pfeiffer']).

pelicula('Serpico', drama, 'Basada en la vida real del policía Frank Serpico. que expone la corrupción policial en la ciudad de Nueva York.','serpico.jpeg').
actores('Serpico', ['Al Pacino']).

pelicula('Dog Day Afternoon', drama, 'La historia de un atraco bancario fallido y el caos que sigue. basada en un evento real ocurrido en la década de 1970.', 'dogday.jpg').
actores('Dog Day Afternoon', ['Al Pacino']).

pelicula('The Godfather Part III', drama, 'La tercera parte de la saga El Padrino. que sigue la vida de Michael Corleone mientras intenta proteger a su familia y su imperio.', 'elpadrino3.jpg').
actores('The Godfather Part III', ['Al Pacino', 'Andy Garcia']).

pelicula('The Devils Advocate', drama, 'La historia de un joven abogado talentoso que se une a un poderoso bufete de abogados liderado por un hombre carismático y diabólico.','deviladvocate.jpg').
actores('The Devils Advocate', ['Keanu Reeves', 'Al Pacino', 'Charlize Theron']).

pelicula('Pirates of the Caribbean: The Curse of the Black Pearl', aventura, 'El capitán Jack Sparrow se embarca en una aventura en alta mar para rescatar a una doncella secuestrada y recuperar un tesoro legendario.', 'piratas.jpeg').
actores('Pirates of the Caribbean: The Curse of the Black Pearl', ['Johnny Depp', 'Orlando Bloom', 'Keira Knightley']).

pelicula('Edward Scissorhands', fantasia, 'La historia de Edward. un hombre con manos de tijera que es llevado a vivir en un suburbio y se enamora de una joven.', 'scissor.jpg').
...
pelicula('Finding Neverland', drama, 'La historia de J.M. Barrie. el autor de Peter Pan. y su inspiración para escribir la famosa obra teatral.', 'finding.jpg').
...
pelicula('Birdman or (The Unexpected Virtue of Ignorance)', comedia, 'Un actor de renombre intenta revitalizar su carrera en Broadway mientras lidia con problemas personales y la voz en su cabeza.','Birdman.jpg').
...
genero_actor(X,A) :- pelicula(X,Y, _, _) , actores(X,Z), A = [Y|Z] .
